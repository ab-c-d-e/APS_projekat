        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedPaperId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeywordScientificPaper", x => new { x.KeywordsId, x.PapersId });
                    table.ForeignKey(
                        name: "FK_KeywordScientificPaper_Keywords_KeywordsId",
                        column: x => x.KeywordsId,
                        principalTable: "Keywords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KeywordScientificPaper_ScientificPapers_PapersId",
                        column: x => x.PapersId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferenceScientificPaper", x => new { x.PapersId, x.ReferencesId });
                    table.ForeignKey(
                        name: "FK_ReferenceScientificPaper_References_ReferencesId",
                        column: x => x.ReferencesId,
                        principalTable: "References",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReferenceScientificPaper_ScientificPapers_PapersId",
                        column: x => x.PapersId,
                        principalTable: "ScientificPapers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaperTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaperTasks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaperTasks_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Notifications_PaperTasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "PaperTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeywordScientificPaper_PapersId",
                table: "KeywordScientificPaper",
                column: "PapersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaperTasks_SectionId",
                table: "PaperTasks",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_PaperTasks_UserId",
                table: "PaperTasks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ReferenceScientificPaper_ReferencesId",
                table: "ReferenceScientificPaper",
                column: "ReferencesId");
